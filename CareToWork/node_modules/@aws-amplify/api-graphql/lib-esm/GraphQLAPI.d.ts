...
export declare class GraphQLAPIClass {
     ...
     * @param operation
     */
    getGraphqlOperationType(operation: any): import("graphql").OperationTypeNode;
    /**
     ...
     */
    graphql({ query: paramQuery, variables, authMode, authToken }: GraphQLOptions, additionalHeaders?: {
        [key: string]: string;
