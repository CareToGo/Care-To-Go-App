...
export interface BottomSheetInternalContextType extends Pick<PanGestureHandlerProps, 'activeOffsetY' | 'activeOffsetX' | 'failOffsetY' | 'failOffsetX' | 'waitFor' | 'simultaneousHandlers'>, Required<Pick<BottomSheetProps, 'enableContentPanningGesture' | 'enableOverDrag' | 'enablePanDownToClose' | 'overDragResistanceFactor'>> {
